...
`CRN:***:`Thursdays between 11:30-14:30 p.m.

## Classroom:

Room *** @ Faculty of Arts and Sciences.
...
<li>To develop critical thinking skills and abilities to apply calculus techniques (i.e., limits,
derivatives, integration, infinite series) to assess the probability of an event. </li>
</ul>
</p>
...
<li>Calculate basic characteristics such as mean and variance of probability distributions, and any probability
associated with this distributions. </li>
...
<ul>
<li>DeGroot., M.H. and Schervish, M.J. (2012). Probability and Statistics. Boston: Addison-Wesley, c2012.
[Hard copy available at ITU Mustafa Inan Library with CALL #QA273 .D445 2012]. </li>
